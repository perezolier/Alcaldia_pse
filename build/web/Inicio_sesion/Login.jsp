<%-- 
    Document   : Login
    Created on : 25 jul 2022, 21:22:08
    Author     : JAPO
--%>
...
<html>
    <head>
        ...
        <title>ProyectoSENA</title>

        <link rel="stylesheet" type="text/css" href="/Alcaldia_pse/estilos/Login.css">
    </head>
    <div id="cuerpo">
        <body>
            <header>
                ...
                <nav id="nav1">
                    <a href="/Alcaldia_pse/index.jsp"><b>Inicio</b></a>
                    ...
                    <a href="/Alcaldia_pse/index.jsp"><button>Retroceder</button></a>
            ...
            <section id="sec1">
                <article>
                    <br>
                    <h3 id="h31">Inicio De Sesión</h3>
                    <form id="form1" action="/Alcaldia_pse/ValidarAcceso" method="post">
                        <br>
                        <label for="">Usuario</label>
                        <br>
                        <input class="controls" type="email" name="correo" id="correo" placeholder="Ingrese su Usuario" required>
                        <br>
                        ...
                        %>
                        <p id="p6"><a id="at" href="#">¿Olvide Contraseña?</a></p>
                    </form>
                    <br>
                    <div>
                        <h3 id="h31">Mapa Del Municipio De Unguía Chocó</h3>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3950.595945247276!2d-77.09464338590006!3d8.040525605900855!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e504e99cd39023d%3A0x287f851bb51142fa!2sAlcaldia%20Municipal%20Unguia!5e0!3m2!1ses!2sco!4v1658803354056!5m2!1ses!2sco" width="900" height="410"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" style="margin: 0 auto; display: block; border: 3px solid #019cba;" alt="Mapa Del Departamento Del Chocó"></iframe>
                    </div>
                </article>
            </section>
