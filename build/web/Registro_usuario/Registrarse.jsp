<%-- 
    ...
    Created on : 24 jul 2022, 20:06:05
    Author     : VICTOR
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Alcaldia_pse/estilos/Registrarse.css">
    </head>
    <body>
        <header>
            <div class="logo">
        ...
        <section id="sec1">
            <article>
                <br>
                <h3 id="h31">FORMULARIO DE REGISTRO</h3> 
                <br>
                <form id="form1" action="/Alcaldia_pse/ValidarRegistroUsuario?accion=Registrar" method="post">
                    ...
                    <br>
                    <input class="controls" type="email" name="Usu_Correo" id="correo" placeholder="Confirme su Coreeo">
                    <br>
                    ...
                    <p>
                    <input class="controls" type="password" name="Usu_Contrasena" id="contraseña" placeholder="Confirme Contraseña">  
                    <p>
